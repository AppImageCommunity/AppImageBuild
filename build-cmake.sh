...
cmake . -DCMAKE_BUILD_TYPE:STRING=Release -DCMAKE_C_STANDARD:STRING=11 -DCMAKE_CXX_STANDARD:STRING=14 -DCMAKE_C_FLAGS:STRING='-D_POSIX_C_SOURCE=199506L -D_POSIX_SOURCE=1 -D_SVID_SOURCE=1 -D_BSD_SOURCE=1' -DCMAKE_EXE_LINKER_FLAGS:STRING='-static-libstdc++ -static-libg$
